...
/// Pause the vault. Authorized by either the vault admin or the factory owner.
///
/// Accounts:
...
///
/// Data:
///   [0] discriminator (0x16)
pub struct PauseVault<'a> {
...
impl<'a> PauseVault<'a> {
    pub const DISCRIMINATOR: u8 = 0x16;
...
impl<'a> TryFrom<(&'a [u8], &'a [AccountInfo])> for PauseVault<'a> {
