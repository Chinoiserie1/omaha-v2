...
/// Factory owner: resume all factory-gated operations.
///
/// Accounts:
///   0. `[signer]`    owner
...
///
/// Data:
///   [0] discriminator (0x13)
pub struct UnpauseFactory<'a> {
    owner: &'a AccountInfo,
    factory_state: &'a AccountInfo,
}

impl<'a> UnpauseFactory<'a> {
...
impl<'a> TryFrom<(&'a [u8], &'a [AccountInfo])> for UnpauseFactory<'a> {
