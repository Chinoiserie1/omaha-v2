...
import { DISC_PAUSE_VAULT, VAULT_PROGRAM_ID } from "../constants.js";
import { writeU8 } from "../utils.js";

export interface PauseVaultParams {
...
/**
 * Create a PauseVault instruction (0x16).
 *
 * Data: [disc(1)] = 1 byte
 *
 * Accounts:
 ...
 */
export function createPauseVaultInstruction(
  params: PauseVaultParams,
): TransactionInstruction {
  const data = Buffer.alloc(1);
  writeU8(data, 0, DISC_PAUSE_VAULT);
